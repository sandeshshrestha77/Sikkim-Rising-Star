...
const eventDetails = {
  ...
  description:
    "The first edition of Sikkim Rising Star expanded its reach to all districts, introducing innovative elements like live streaming and an international jury panel. This landmark event celebrated diverse talents and inspired participants across the region.",
  statistics: [
  ...
  winners: [
    {
      ...
      category: "Dancing",
      prize: "₹4,00,000",
      achievement: "Performing with a national dance company",
    ...
    },
    {
      ...
      category: "Music",
      prize: "₹2,00,000",
      achievement: "Founded a music academy",
    ...
    },
    {
      ...
      category: "Singing",
      prize: "₹1,00,000",
      achievement: "Host of a local radio show",
